...
def main() -> int:
    ...
    audit_summary = run_adverb_audit(args.db, str(artifacts_dir))
    reject_csv = artifacts_dir / "adverb_ru_gloss_reject_auto.csv"
    review_csv = artifacts_dir / "adverb_ru_gloss_review.csv"
    ...
    out = artifacts_dir / "adverb_semi_auto_pipeline_summary.json"
