...
OUT_DIR = Path("tmp/2k_adjectives_priority_audit")
CSV_PATH = OUT_DIR / "staging_2k_adjectives_priority_audit.csv"
JSON_PATH = OUT_DIR / "staging_2k_adjectives_priority_audit.json"
...
def main() -> None:
    ...
    summary = {
        "db_path": str(DB_PATH),
        "total_2k_adjectives_active_rows": len(rows),
    ...
    print("===== STAGING 2K ADJECTIVES PRIORITY AUDIT SUMMARY =====")
