...
def _intro_text() -> str:
    return (
        "Оцениваем ваш пассивный словарный запас португальского языка. Прохождение теста займёт около трёх минут.\n\n"
        "Вам будут показаны 24 португальских слова. Ваша задача – выбрать их правильный перевод на русский.\n\n"
        'Старайтесь не угадывать, это тест на честность. Если не уверены, жмите "❗️Не знаю".'
    )
