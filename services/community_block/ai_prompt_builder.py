...
SYSTEM_PROMPT = (
    ...
    "Пиши очень коротко: обычно 1–2 предложения, без списков, без буллетов, без длинных вводных, "
    "без резюме, без рекламы, без канцелярита. "
    "Не задавай встречный вопрос, если без него можно обойтись. "
...
def build_prompt_payload(snapshot: ThreadSnapshot, decision: PlanDecision) -> dict:
    ...
    user_prompt = (
        ...
        "который не выглядит как бот. Строго без списков, без буллетов, "
        "без длинных объяснений, обычно до 220 символов. "
        "Лучше 1–2 коротких предложения.\n\n"
