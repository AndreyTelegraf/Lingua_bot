...
def test_run_vocab_v2_start_ui_marks_cat_branch(monkeypatch) -> None:
    monkeypatch.setattr(
        mod,
        "run_vocab_v2_start",
        lambda **kwargs: {
...
def test_run_vocab_v2_start_ui_defaults_to_legacy(monkeypatch) -> None:
    monkeypatch.setattr(
        mod,
        "run_vocab_v2_start",
        lambda **kwargs: {
...
def test_run_vocab_v2_callback_ui_marks_cat_branch(monkeypatch) -> None:
    monkeypatch.setattr(
        mod,
...
def test_run_vocab_v2_callback_ui_defaults_to_legacy(monkeypatch) -> None:
    monkeypatch.setattr(
        mod,
        "run_vocab_v2_callback",
        lambda **kwargs: {
