...
def test_run_adjective_audit(tmp_path: Path):
    db = tmp_path / "t.db"
    ...
    conn.execute("""
        ...
        values
        (1, 'bonito', 'bonito', 'бонито', null, null, 'adjective', null, 1, '', '', null, null, null, null, null)
    """)
    vals = ["бонито","красивый","большой","синий","плохой","маленький"]
    ...
    summary = run_adjective_audit(str(db), str(tmp_path))
